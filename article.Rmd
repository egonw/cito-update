...
Basically, when you cite a journal article or dataset (or any other soruce), you also explain
...
*Journal of Cheminformatics*. Based on CiTO annotation available in Wikdiata, the ten
...
allow collections of annotations to be shared. Then, when archived on Zenodo and therefore citatble,
