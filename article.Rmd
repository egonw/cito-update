...
|**Year** |**Type**  |**Article** |**Intentions** | **% Annotated citaions** |
--- |----- |------------ |------------ |---
|Year 1|Editorial|Adoption of the Citation Typing Ontology by the *Journal of Cheminformatics* [@citesForInformation:Willighagen_2020]|cito:citesAsAuthority, cito:citesForInformation, cito:usesMethodIn||
||Methodology|Predicting target profiles with confidence as a service using docking scores [@citesForInformation:Ahmed2020]|cito:agreesWith, cito:extends, cito:citesAsAuthority, cito:citesAsDataSource, cito:usesMethodIn|
...
||Educational|A ligand-based computational drug repurposing pipeline using KNIME and Programmatic Data Access: case studies for rare diseases and COVID-19 [@citesForInformation:Tuerkova2020]|cito:agreesWith, cito:citesAsAuthority, cito:citesAsDataSource, cito:discusses, cito:usesDataFrom, cito:usesMethodIn||
